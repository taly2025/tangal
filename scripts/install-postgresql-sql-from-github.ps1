param(
    ...
    [string]$Ref = "master",
    [string]$SkillPath = "skills/postgresql-sql",
...
$destinationPath = Join-Path (Join-Path $CodexHome "skills") "postgresql-sql"
...
Write-Host "Installing postgresql-sql from GitHub..."
...
Write-Host "postgresql-sql installed successfully."
